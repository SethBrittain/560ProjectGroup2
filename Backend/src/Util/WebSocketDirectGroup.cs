...
/// </summary>
public class WebSocketDirectGroup
{

    /// <summary>
    /// Event handler for when the channel is emptied after all clients disconnect
    /// </summary>
    public delegate void DirectGroupEmptyHandler();
    public DirectGroupEmptyHandler _disposal;
    ...
    /// <summary>
    /// Constructor for new WebSocketDirectGroup
    /// </summary>
    /// <param name="channelId">The unique identifier of channel</param>
    public WebSocketDirectGroup(DirectGroupEmptyHandler disposal)
    {
        _disposal = disposal;
    }
    ...
    /// <returns></returns>
    public async Task Broadcast(DirectMessage cm)
    {
